...
const Search = () => {
  ...
  useEffect(() => {
    ...
    const fetchAllPackages = async () => {
      ...
      try {
        ...
        const res = await fetch(`${import.meta.env.VITE_URL}/api/package/get-packages?${searchQuery}`);
  ...
  const onShowMoreSClick = async () => {
    ...
    const searchQuery = urlParams.toString();
    const res = await fetch(`${import.meta.env.VITE_URL}package/get-packages?${searchQuery}`);
    const data = await res.json();
